...
REPORT_NOTE_OVERRIDE = {
    ...
    "陳信全": "待轉核",   # 還沒正式核准、等轉核才算（轉核後再手動移待撥款）
    "葉玥樂": "",
    # 手機分期
    "柯忻恩": "補時段+確認電話",
    "劉娟伶": "手機分期/缺帳單",   # 要送手機分期、缺帳單未送
    "曾月英": "分貝機/銀/C/商/當",    # 送件順序（還沒決定送哪家）
    # 零卡（全部沒備註）
    "王家齊": "", "江淑芳": "", "高峰瑛": "", "王思婷": "", "李宜芳": "",
    "黃晏柔": "", "陳玥汝": "", "陳弈叡": "", "呂昶宗": "", "吳宗燁": "",
    "黃文忠": "", "張維鋼": "", "黎俊志": "",
...
CONCURRENT_CO = {
    ...
    "洪慧瑜": ["第一"],     # 21核准25萬、第一 待核准20萬（等補母時段）
}

# 額外已核准但未撥款的公司（除了 current/PENDING_DISB 記的那家外）
EXTRA_APPROVED = {
    "楊創富": [("亞太", "12")],   # 除了第一 28萬（撥款）外，亞太 12萬也有核准
    # 洪慧瑜 第一 20萬 還在「待核准」（等補母時段），不算已核准 → 移到 COMPANY_NOTES
}
